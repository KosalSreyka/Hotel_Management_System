...
namespace Hotel_Management_System
{
    ...
    {
        string No = "", Free = "";
        SqlConnection conn = new SqlConnection("Data Source=MSI;Initial Catalog=Hotel_Management_System;Integrated Security=True");
        SqlConnection conn1 = new SqlConnection("Data Source=MSI;Initial Catalog=Hotel_Management_System;Integrated Security=True");
        SqlConnection conn3 = new SqlConnection("Data Source=MSI;Initial Catalog=Hotel_Management_System;Integrated Security=True");
        SqlConnection conn2 = new SqlConnection("Data Source=MSI;Initial Catalog=Hotel_Management_System;Integrated Security=True");
        SqlConnection conn4 = new SqlConnection("Data Source=MSI;Initial Catalog=Hotel_Management_System;Integrated Security=True");
